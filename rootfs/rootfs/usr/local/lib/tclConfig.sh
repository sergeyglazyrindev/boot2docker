...
TCL_EXTRA_CFLAGS='-mtune=generic -Os -pipe -pipe -m64 '
...
TCL_CC_SEARCH_FLAGS='-Wl,-rpath,${LIB_RUNTIME_DIR}:/usr/local/lib'
TCL_LD_SEARCH_FLAGS='-Wl,-rpath,${LIB_RUNTIME_DIR}:/usr/local/lib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/local/lib -ltcl8.5'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/local/lib -ltclstub8.5'
...
TCL_BUILD_STUB_LIB_PATH='/usr/local/lib/libtclstub8.5.a'
