...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--prefix=/usr/local' '--localstatedir=/var' '--enable-shared' '--with-system-expat' '--with-system-ffi' 'CC=gcc -flto -fuse-linker-plugin -mtune=generic -Os -pipe'",
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/usr/src/Python-2.7.10',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/usr/src/Python-2.7.10 ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/usr/src/Python-2.7.10',
 'abs_srcdir': '/usr/src/Python-2.7.10',
