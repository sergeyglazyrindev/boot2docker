...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/local/lib -ltk8.5'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/local/lib -ltkstub8.5'
...
TK_BUILD_STUB_LIB_PATH='/usr/local/lib/libtkstub8.5.a'
